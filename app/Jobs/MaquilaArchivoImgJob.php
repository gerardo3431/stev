...
class MaquilaArchivoImgJob implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            if(Storage::disk('public')->exists($folio->maq_file_img)){
                ...
                $filePath = 'public/storage/maquila/MI-' . $this->folio . '.pdf';
            ...
            $folio->update(['maq_file_img' => 'maquila/MI-'. $this->folio . '.pdf']);
        } catch (\Throwable $th) {
