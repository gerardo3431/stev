...
class RecepcionsHasProfiles extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('recepcions_has_profiles', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('recepcions_has_profiles');
    }
}
