...
function textarea(clave, documento, estudio, status, folio = null){
    let elemento = document.querySelector('.appendComponente' + folio).querySelector('.asignEstudio'+estudio).querySelector('#documento'+clave);
