...
<!-- Modal -->
{{-- gris normal       #e2e2e2 --}}
{{-- gris transparente #e2e2e25e   #e2e2e27a--}}
{{-- focus input       #6571ff52   #6773fa61 --}}
{{-- box-shadow: 0 0px 3px #6773fa --}}
{{-- MORADO #6773fa --}}
{{-- VERDE #05a34a --}}
            ...
            <div class="modal-footer">
                ...
                {{-- @if (auth()->user()->first()->labs()->first()->paquete()->first()->paquete == 'completo')
                    <div class="btn-group" role="group">
                        ...
                        <i class="mdi mdi-whatsapp "></i> + opciones
                        </button>
                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                            <a onclick='send_email(this)' type="button" class="dropdown-item" href="#">
                                Enviar a correo del paciente. </a>
                            <a href="#" type="button" class="dropdown-item" onclick="open_modal_correo(this)">
                                Enviar a correo</a>
                            <a onclick='open_modal_sms(this)' type="button" class="dropdown-item" href="#">
                                Enviar a cuenta de WhatsApp del paciente.</a>
                        </div>
                    </div>
                @endif --}}
                @can('entrega_resultados')
