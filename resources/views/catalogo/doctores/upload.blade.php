...
<div class="row">
    <div class="col-sm-8  stretch-card">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{route('stevlab.catalogo.doctor-upload-user')}}">
                @csrf  
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror" name="name" value="{{$doctor->nombre}}"type="text">
                            @error('name')
                            <span class="invalid-feedback">
                                <strong>{{$message}}</strong>
                            </span>
