        ...
        <div class="mb-3">
            <div class="row">
                <nav class="page-breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('stevlab.empresa.dashboard')}}">StevLab</a></li>
                        <li class="breadcrumb-item" aria-current="page"> <a href="{{route('stevlab.empresa.dashboard')}}">Empresa</a> </li>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <button onclick="enviar_prefolio()" type="submit" class="btn btn-success"><i class="mdi mdi-whatsapp "></i> Enviar por whatsapp</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('stevlab.empresa.store-file-prefolio')}}" class="form-sample mb-3" id='formImagen' enctype="multipart/form-data" method="POST">
                    @csrf
...
@push('custom-scripts')
    <script src="{{ asset('public/stevlab/empresa/prefolio/form-validation.js') }}?v=<?php echo rand();?>"></script>
    <script src="{{ asset('public/stevlab/empresa/prefolio/select2.js') }}?v=<?php echo rand();?>"></script>
    <script src="{{ asset('public/stevlab/empresa/prefolio/functions.js') }}?v=<?php echo rand();?>"></script>
    <script src="{{ asset('public/stevlab/empresa/prefolio/dropify.js') }}?v=<?php echo rand();?>"></script>
    <script src="{{ asset('public/stevlab/empresa/prefolio/textarea.js') }}?v=<?php echo rand();?>"></script>
@endpush