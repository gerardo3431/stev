...
@else
    @if (session('idpaciente'))
        ...
        <input type="hidden" id="data_id_paciente" name="data_id_paciente" class="form-control" value="{{session('idpaciente')}}">
        <input type="hidden" id="data_id_doctor" name="data_id_doctor" class="form-control" value="{{session('iddoctor')}}">
        <input type="hidden" id="data_observaciones" name="data_observaciones" class="form-control" value="{{session('observaciones')}}">
        <input type="hidden" id="data_prefolio" name="data_prefolio" class="form-control" value="{{session('idprefolio')}}">
    @endif
<div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-2 col-lg-1">
                            <div class="mb-3">
                                ...
                                <input  class="form-control @error('prefolio') is-invalid @enderror" id='prefolio' name="prefolio" type="text" readonly="readonly" value="{{session('prefolio')}}">
                                {{-- <input  class="form-control @error('prefolio') is-invalid @enderror" id='prefolio' name="prefolio" type="text" readonly="readonly" value="{{session('prefolio')}}"> --}}
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-2 col-lg-2">
                            <div class="mb-3">
                                ...
                                <input  class="form-control @error('folio') is-invalid @enderror" id='folio' name="folio" type="text" readonly="readonly" value="">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="mb-3">
                                ...
                                <input class="form-control" id='clave' name="clave" value="{{old('clave')}}" type="text">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="mb-3">
                        ...
                        <form id='storeDoctorForm'>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        <label class="form-label">Nombre</label>
                                        <input class="form-control" name="nombre" value="{{old('nombre')}}" type="text" placeholder="Nombre completo">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="mb-3">
                    ...
                    {{-- <div class="row" id='medidas'>
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        <input id='ancho' name="ancho_ticket" type="text" class="form-control" placeholder="Ancho cm" value="4.8">
                                    </div>
                                </div><!-- Col -->
                            </div>
                        </div>
...
<script src="{{ asset('public/stevlab/recepcion/registro/select2.js') }}?v=<?php echo rand();?>"></script>
<script src="{{ asset('public/stevlab/recepcion/registro/caja.js') }}?v=<?php echo rand();?>"></script>
<script src="{{ asset('public/stevlab/recepcion/registro/datepicker.js') }}?v=<?php echo rand();?>"></script>
<script src="{{ asset('public/stevlab/recepcion/registro/form-validation.js') }}?v=<?php echo rand();?>"></script>
<script src="{{ asset('public/stevlab/recepcion/registro/functions.js') }}?v=<?php echo rand();?>"></script>
<script src="{{ asset('public/stevlab/recepcion/registro/inputmask.js') }}?v=<?php echo rand();?>"></script>
