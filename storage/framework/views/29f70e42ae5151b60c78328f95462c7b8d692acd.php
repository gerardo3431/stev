...
<div class="row">
    <div class="col-sm-8  stretch-card">
        <div class="card">
            <div class="card-body">
                <form method="post" action="<?php echo e(route('stevlab.catalogo.doctor-upload-user')); ?>">
                <?php echo csrf_field(); ?>  
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($doctor->nombre); ?>"type="text">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/pixelar6/micromed.book-medical.com/resources/views/catalogo/doctores/upload.blade.php ENDPATH**/ ?>