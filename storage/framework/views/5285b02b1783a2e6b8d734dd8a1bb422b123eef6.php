...
<?php $__env->startSection('content'); ?>
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"> <a href="">Doctores</a> </li>
            <li class="breadcrumb-item active" aria-current="page"> <a href="">Crear usuario doctor</a> </li>
        </ol>
    </nav>
...
<div class="row">
    <div class="col-sm-8  stretch-card">
        <div class="card">
            <div class="card-body">
                <form method="post" action="<?php echo e(route('stevlab.catalogo.doctor-update-user')); ?>">
                <?php echo csrf_field(); ?>  
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" name="id" value="<?php echo e($doctor->id); ?>"type="text">
                            <?php $__errorArgs = ['id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($doctor->name); ?>"type="text">
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e($doctor->email); ?>" type="text">
...
unset($__errorArgs, $__bag); ?>" name="username" value="<?php echo e($doctor->usernmae); ?>">
...
unset($__errorArgs, $__bag); ?>" name="cedula" value="<?php echo e($doctor->cedula); ?>">
...
unset($__errorArgs, $__bag); ?>" name="universidad" value="<?php echo e($doctor->universidad); ?>">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/pixelar6/micromed.book-medical.com/resources/views/catalogo/doctores/edit.blade.php ENDPATH**/ ?>