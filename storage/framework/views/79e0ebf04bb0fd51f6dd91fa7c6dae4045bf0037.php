...
<head>
  ...
  <?php if(Route::has('resultados.index')): ?>
      <title>Resultados - Stevlab</title>
  <?php elseif(Route::has('resultados.show')): ?>
    <title>Lista - Stevlab</title>
  <?php else: ?>
    <title>Login - Stevlab</title>
  <?php endif; ?>
...
</html><?php /**PATH /home2/pixelar6/micromed.book-medical.com/resources/views/layout/master2.blade.php ENDPATH**/ ?>