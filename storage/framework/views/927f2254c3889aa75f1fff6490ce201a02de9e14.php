...
<div class="row">
    <div class="col-sm-8  stretch-card">
        <div class="card">
            <div class="card-body">
                <form method="post" action="<?php echo e(route('stevlab.catalogo.empresa-update-user')); ?>">
                <?php echo csrf_field(); ?>  
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($empresa->name); ?>"type="text">
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e($empresa->email); ?>" type="text">
...
unset($__errorArgs, $__bag); ?>" name="username" value="<?php echo e($empresa->usernmae); ?>">
...
unset($__errorArgs, $__bag); ?>" name="cedula" value="<?php echo e($empresa->cedula); ?>">
...
unset($__errorArgs, $__bag); ?>" name="universidad" value="<?php echo e($empresa->universidad); ?>">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/pixelar6/micromed.book-medical.com/resources/views/catalogo/empresas/edit.blade.php ENDPATH**/ ?>